  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'flex h-full w-[--sidebar-width] flex-col bg-sidebarx text-sidebar-foreground',
            className,
          )}
          ref={ref}
          {...props}
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar='sidebar'
            className='flex h-full w-full flex-col bg-sidebarx group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow'
          >
            {children}
          </div>
        </div>
